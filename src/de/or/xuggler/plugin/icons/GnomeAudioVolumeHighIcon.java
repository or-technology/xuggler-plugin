 ...
 * transcoder</a>.
 */
public class GnomeAudioVolumeHighIcon extends FlamingoSvgJavaIcon {
    ...
    public synchronized void paintIcon(Component c, Graphics g, int x, int y)
    {
        if (image == null)
        {
            ...
            double coef = Math.min((double) width / (double) 48, (double) height / (double) 45);
    ...
    private static void paint(Graphics2D g)
    {
        ...
        g.setPaint(new RadialGradientPaint(new Point2D.Double(72.49568176269531, 22.84375), 4.82023f, new Point2D.Double(72.49568176269531, 22.84375), new float[] {
            0, 0.6f, 1 }, new Color[] {
            new Color(0x729FCF), new Color(0x729FCF), new Color(0x729FCF, true) }, NO_CYCLE, SRGB, new AffineTransform(2.6999424f, 0, 0, 3.6828427f, -122.46854f, -61.286186f)));
        ...
        g.setPaint(new RadialGradientPaint(new Point2D.Double(70.53125, 22.734375), 3.5975378f, new Point2D.Double(70.53125, 22.734375), new float[] {
            0, 0.6f, 1 }, new Color[] {
            new Color(0x729FCF), new Color(0x729FCF), new Color(0x729FCF, true) }, NO_CYCLE, SRGB, new AffineTransform(1.8087116f, 0, 0, 3.5234272f, -57.039448f, -57.36854f)));
        ...
        g.setPaint(new RadialGradientPaint(new Point2D.Double(60.640625, 22.65625), 2.6194003f, new Point2D.Double(60.640625, 22.65625), new float[] {
            0, 0.6f, 1 }, new Color[] {
            new Color(0x729FCF), new Color(0x729FCF), new Color(0x729FCF, true) }, NO_CYCLE, SRGB, new AffineTransform(2.1454532f, 0, 0, 3.0191636f, -69.461f, -45.746674f)));
