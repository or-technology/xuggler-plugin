 ...
 * transcoder</a>.
 */
public class GnomeAudioVolumeMediumIcon extends FlamingoSvgJavaIcon {

    /**
     * Creates a new transcoded SVG image.
     */
    public GnomeAudioVolumeMediumIcon()
    {
        this(42, 40);
    }
     ...
     * Creates a new transcoded SVG image.
     */
    public GnomeAudioVolumeMediumIcon(int width, int height)
    {
        this.width = width;
        this.height = height;
    }
    ...
    public synchronized void paintIcon(Component c, Graphics g, int x, int y)
    {
        if (image == null)
        {
            ...
            double coef = Math.min((double) width / (double) 42, (double) height / (double) 40);
