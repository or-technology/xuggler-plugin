...
public class GnomeMediaSeekForwardIcon extends FlamingoSvgJavaIcon {
     ...
     */
    public GnomeMediaSeekForwardIcon()
    {
        this(40, 26);
    }
     ...
     * Creates a new transcoded SVG image.
     */
    public GnomeMediaSeekForwardIcon(int width, int height)
    {
        this.width = width;
        this.height = height;
    }
    ...
    private static void paint(Graphics2D g)
    {
        ...
        g.transform(new AffineTransform(1, 0, 0, 1, 150, 0));
        ...
        // _0_0_0_1
        transformations.offer(g.getTransform());
        g.transform(new AffineTransform(1, 0, 0, 1, -267, 0));

        // _0_0_0_1_0
        transformations.offer(g.getTransform());
        g.transform(new AffineTransform(1, 0, 0, 1, -18, 0));

        // _0_0_0_1_0_0

        // _0_0_0_1_0_0_0
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(141.5, 35.0);
        ((GeneralPath) shape).lineTo(141.5, 13.000461);
        ((GeneralPath) shape).lineTo(159.99577, 24.010195);
        ((GeneralPath) shape).lineTo(141.5, 35.0);
        ((GeneralPath) shape).closePath();

        g.setPaint(new RadialGradientPaint(new Point2D.Double(36.455379486083984, 17.41456413269043), 13.55237f, new Point2D.Double(36.455379486083984, 17.41456413269043), new float[] {
            0, 1 }, new Color[] {
            new Color(0xEEEEEC), new Color(0x92948F) }, NO_CYCLE, SRGB, new AffineTransform(1.8811669f, 0, 0, 1.5641941f, 82.169235f, 0.3959845f)));
        g.fill(shape);
        g.setPaint(new Color(0x555753));
        g.setStroke(new BasicStroke(1, 2, 0, 4));
        g.draw(shape);
        transformations.offer(g.getTransform());
        g.transform(new AffineTransform(1, 0, 0, 1, 120, 0));
        ...
        g.setTransform(transformations.poll()); // _0_0_0_1_0_0_1
        ...
        g.setTransform(transformations.poll()); // _0_0_0_1_0_1_1

        g.setTransform(transformations.poll()); // _0_0_0_1_0
        g.setComposite(AlphaComposite.getInstance(3, 0.15f * origAlpha));
        transformations.offer(g.getTransform());
        g.transform(new AffineTransform(1, 0, 0, -1, -150, 48));

        // _0_0_0_1_1
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(7.0, 13.875);
        ((GeneralPath) shape).lineTo(7.0, 34.125);
        ((GeneralPath) shape).lineTo(24.03125, 24.0);
        ((GeneralPath) shape).lineTo(7.0, 13.875);
        ((GeneralPath) shape).closePath();
        ((GeneralPath) shape).moveTo(25.0, 13.875);
        ((GeneralPath) shape).lineTo(25.0, 23.6875);
        ((GeneralPath) shape).curveTo(24.995693, 23.80298, 24.951525, 23.913406, 24.875, 24.0);
        ((GeneralPath) shape).curveTo(24.951525, 24.086594, 24.995693, 24.19702, 25.0, 24.3125);
        ((GeneralPath) shape).lineTo(25.0, 34.125);
        ((GeneralPath) shape).lineTo(42.0, 24.0);
        ((GeneralPath) shape).lineTo(25.0, 13.875);
        ((GeneralPath) shape).closePath();

        g.setPaint(new LinearGradientPaint(new Point2D.Double(-0.0034508048556745052, 10.043009757995605), new Point2D.Double(48.12845230102539, 37.83197784423828), new float[] {
        ...
        g.setTransform(transformations.poll()); // _0_0_0_1_1
