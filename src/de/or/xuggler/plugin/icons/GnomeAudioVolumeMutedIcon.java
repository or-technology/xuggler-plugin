...
public class GnomeAudioVolumeMutedIcon extends de.or.guiUtils.icons.FlamingoSvgJavaIcon {
     ...
     */
    public GnomeAudioVolumeMutedIcon()
    {
        this(47, 40);
    }
     ...
     * Creates a new transcoded SVG image.
     */
    public GnomeAudioVolumeMutedIcon(int width, int height)
    {
        this.width = width;
        this.height = height;
    }
    ...
    protected void paint(Graphics2D g)
    {
        ...
        // _0_1
        transformations.offer(g.getTransform());
        g.transform(new AffineTransform(1.0828519f, 0, 0, 1.0830642f, 1.5587564f, -0.36757f));
        ...
        g.setStroke(new BasicStroke(0.92015547f, 1, 1, 4));
        g.draw(shape);
        ...
        // _0_1_0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(35.0, 20.0);
        ((GeneralPath) shape).lineTo(40.0, 25.0);

        g.setStroke(new BasicStroke(1.3850954f, 1, 0, 4));
        g.draw(shape);

        // _0_1_0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(40.0, 20.0);
        ((GeneralPath) shape).lineTo(35.0, 25.0);

        g.draw(shape);

        g.setTransform(transformations.poll()); // _0_1_0_0
